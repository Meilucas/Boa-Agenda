<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="wwwroot.medico.Default" MasterPageFile="~/Master.Master" %>
...
<asp:Content ContentPlaceHolderID="body" runat="server">
    ...
    <div class="table-responsive">
        <asp:GridView runat="server" ID="gdvUser" AutoGenerateColumns="False" CssClass=" table table-hover" OnSelectedIndexChanging="gdvUser_SelectedIndexChanging">
            <Columns>
                <asp:BoundField HeaderText="Id" DataField="id_medico" />
